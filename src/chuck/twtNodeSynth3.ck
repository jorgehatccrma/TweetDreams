...
public class twtNodeSynth2
{
    ...
    public void trigger( int hopLevel )
    {
        ...
        // connect
        if( isConnected ) {
            <<< "[sound synth] twtNodeSynth2 WARNING: triggering a synth that's already playing! *&*&*&*&*&*&*&*&*&*&*", "" >>>;
            return;
        }
        ...
        //<<< "[sound synth] connecting ", wavNames[ wavNum ] >>>;  // DEBUG
        ...
        for( 0 => int i; i < numSeqSteps; i++)
        {
            ...
            if (midiNote != noNoteCode ) 
            {
                ...
                //<<< "[sound synth] filt freq", tempF >>>;   //DEBUG
